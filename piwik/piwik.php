 ...
 * Description: Piwik Analytics Plugin for The Red Matrix
 * Version: 1.2
 * Author: Tobias Diekershoff <https://f.diekershoff.de/profile/tobias>
 * Author: Klaus Weidenbach
 */

/*   Piwik Analytics Plugin for The Red Matrix
 *
...
function piwik_plugin_admin (&$a, &$o) {
	...
	$o = replace_macros( $t, array(
		...
		'$trackjserror' => array('trackjserror', t('Enable frontend JavaScript error tracking'), get_config('piwik','trackjserror' ), '')
	));
}
